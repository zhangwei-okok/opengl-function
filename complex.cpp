...
int main() {
    ...
    // -------------------------
    Shader shader("../shader/10.2.instancing.vs", "../shader/10.2.instancing.fs");
    ...
    for (int k = 0; k < 3; k++) {
        ...
        switch (k) {
            case 0:
                saveBmpForRGBA(&bmpData[0], SCR_WIDTH, SCR_HEIGHT, "complex_1");
                break;
            case 1:
                saveBmpForRGBA(&bmpData[0], SCR_WIDTH, SCR_HEIGHT, "complex_2");
                break;
            case 2:
                saveBmpForRGBA(&bmpData[0], SCR_WIDTH, SCR_HEIGHT, "complex_3");
                break;
        }
